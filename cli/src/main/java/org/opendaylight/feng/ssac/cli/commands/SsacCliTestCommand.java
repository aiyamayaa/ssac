 ...
 */
package org.opendaylight.feng.ssac.cli.commands;
...
public class SsacCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SsacCliTestCommand.class);
    protected final SsacCliCommands service;

    public SsacCliTestCommand(final SsacCliCommands service) {
